...
class CustomUser(AbstractUser):
    ...
    nickname = models.CharField(max_length=30, blank=True, unique=True, required=True)
    name = models.CharField(max_length=30, blank=True, required=True)
    surname = models.CharField(max_length=30, blank=True, required=True)
    bio = models.TextField(max_length=500, blank=True)
    birth_date = models.DateField(null=True, blank=True, required=True)
